...
class GNN(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = GCNConv(15, 16)  # Input is 15 features 
...
def evaluate_metrics(model, loader, seed, save_fig=None):
    model.eval()
    all_preds = []
    all_labels = []
...
if __name__ == '__main__':
    ...
    with open('model_training_output.txt', 'w') as f:
        ...
        for data_file in dataset:
            ...
            Inference_path = f"C:/Users/Asus/OneDrive/Desktop/Project_implementation/Inferences/Inference_for_{data}_15_features/"
            ...
            for seed in tqdm(random_seeds, desc="Running model with different random seeds"):
                ...
                accuracy, precision, recall, f1, auc, mcc = evaluate_metrics(model, test_loader, seed, save_fig= Inference_path + f'Confusion matrix')
